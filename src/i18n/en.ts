export const en = {
  ...
  host: {
    ...
    coolingHelp: 'Share of dissipated heat that shows up as fan power. Chassis height caps fan diameter and power scales with the cube of RPM, which is why 1U costs several times 4U.',
    heatLoad: 'heat',
    board: 'Mainboard',
    drives: 'Drives',
    driveCount: 'Count',
